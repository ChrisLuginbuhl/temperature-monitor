// Temperature sensing using Particle Boron and an exposed variable
...
void setup() {
    Serial.begin(9600);
     // Register variable immediately with default value to expose this as a Particle Variable visible remotely
